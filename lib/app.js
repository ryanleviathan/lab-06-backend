...
app.post('/cars/', async(req, res) => {
  try {
    ...
    RETURNING *`, [newName, newMake, newModel, newCoolFactor, newImg, newOwnsBool, newOwnerId]);
...
app.put('/cars/:id', async(req, res) => {
  try {
    ...
    const data = await client.query(`
    UPDATE cars SET name = $1, make = $2, model = $3, cool_factor = $4, img = $5, owns = $6, owner_id = $7 
    WHERE cars.id = $8`, 
    [newName, newMake, newModel, newCoolFactor, newImg, newOwnsBool, newOwnerId]);
